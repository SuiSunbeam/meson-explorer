...
const icons = { aptos, arb, aurora, avax, beam, bnb, cfx, cronos, eos, eth, goerli: eth, evmos, ftm, linea, movr, one, opt, polygon, scroll, sepolia, skale, sui, tron, zkevm, zksync }
